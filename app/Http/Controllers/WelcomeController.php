...

{
    ...
    // free 3 day pass functionality


    public function free_3_day_pass(Request $request){

        $data = [];

        $data['all_states'] = $this->getState(['US','CA']);
        return view('free-3-day-pass-to-brandnook', $data); 

    }

    public function free_3_day_pass_request(Request $request){
